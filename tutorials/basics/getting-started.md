...
- [GitHub Docs 入门](https://docs.github.com/zh/get-started)
- [菜鸟教程：Github 简明教程](https://www.runoob.com/w3cnote/git-guide.html)
- [廖雪峰：使用 GitHub](https://liaoxuefeng.com/books/git/github/index.html)
...
建议新手先在网页端创建仓库，再把本地项目推送上去。这样可以同时理解 GitHub 仓库、远程地址和本地 Git 仓库之间的关系。
...
参考廖雪峰教程中的协作路径，最稳妥的流程是：Fork 原仓库、Clone 自己账号下的仓库、本地提交、Push 到自己的远程分支，再向原仓库发起 Pull Request。
